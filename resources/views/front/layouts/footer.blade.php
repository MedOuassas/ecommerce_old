...
<script src="{{ asset('design/front') }}/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="{{ asset('design/front') }}/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="{{ asset('design/front') }}/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="{{ asset('design/front') }}/js/bxslider.min.js"></script>
<script type="text/javascript" src="{{ asset('design/front') }}/js/script.slider.js"></script>
@yield('jscript')
</body>
