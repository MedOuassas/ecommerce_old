...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {!! Form::select('main_lang', ['ar'=>trans('admin.arab'),'en'=>trans('admin.english')], setting()->main_lang, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
        ...
        @if(!empty(setting()->logo))
            <img src="{{ Storage::url(setting()->logo) }}" alt="{{ setting()->sitename_en }}" style="max-width:200px">
        @endif
        <div class="form-group">
        ...
        @if(!empty(setting()->icon))
            <img src="{{ Storage::url(setting()->icon) }}" alt="{{ setting()->sitename_en }}" style="max-width:200px">
        @endif
        <div class="form-group">
        ...
        <a href="{{ aurl() }}" class="btn btn-default">{{ trans('admin.cancel') }}</a>
        {!! Form::close([]) !!}
    </div>
</div>
@endsection