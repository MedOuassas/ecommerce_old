<a href="{{ aurl('makers/'.$id.'/edit') }}" class="btn btn-primary margin"><i class="fa fa-edit fa-fw"></i></a>
...
<div class="modal fade" id="delete_item{{$id}}" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
        {!! Form::open(['route'=>['makers.destroy',$id], 'method'=>'delete']) !!}
        ...
        <div class="modal-body">
            <div class="alert alert-danger">
                <h3>{{ trans('admin.delete_this', ['name'=> lang()=='en'?$name_en:$name_ar]) }} ?</h3>
            </div>
        </div>
