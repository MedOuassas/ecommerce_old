...
<div class="row">
    <div class="col-md-6 col-md-offset-3 col-xs-12">
        <div class="box">
            ...
            <div class="box-body">
                {!! Form::open(['id' => 'edit', 'url' => aurl('cities/'.$city->id), 'method' => 'put']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('country_id', App\Model\Country::pluck('country_name_en','id'),$city->country_id, ['class' => 'form-control']) !!}
                </div>
